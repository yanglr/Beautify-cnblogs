- [前端小白也能快速学会的博客园博客美化全攻略](#---------------------)
  ...
  * [准备工作](#----)
    + [js权限申请](#js----)
  * [如何模仿一个博客园的自定义风格(样式css+动态效果js)?](#------------------css-----js--)
  * [markdown样式自定义](#markdown-----)
  * [在页面顶部添加"自定义搜索"功能](#----------------)
  * [在页面顶部添加"音乐播放器"(Flash)播放背景音乐](#---------------flash-------)
  * [在页面顶部添加"Fork me on Github"图标](#--------fork-me-on-github---)
  * [为导航栏设置渐变背景色](#-----------)
  * [在公告栏添加滚动文字](#----------)
  * [在公告栏加入自己的社交网络账号 - 图片链接](#----------------------)
  * [在公告栏添加一个能旋转的rss图标](#------------rss--)
  * [在公共栏添加"小人时钟"(Flash)](#-------------flash-)
  * [在公共栏添加"站点统计"功能](#--------------)
  * [在公告栏中加入"自定义搜索"(PopUp弹窗)](#---------------popup---)
  ...
  * [微博秀的嵌入(支持http/https访问)](#---------http-https---)
  * [分享组件的嵌入(支持http/https访问)](#----------http-https---)
  * [打赏功能](#----)
  * [复制文字 自动加版权](#----------)
  * [隐藏博文右下角的"反对"](#------------)
